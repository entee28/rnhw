...
export type GetCountryQuery = { __typename?: 'Query', country?: { __typename?: 'Country', emoji: string, name: string, code: string, phone: string, continent: { __typename?: 'Continent', name: string } } | null };
